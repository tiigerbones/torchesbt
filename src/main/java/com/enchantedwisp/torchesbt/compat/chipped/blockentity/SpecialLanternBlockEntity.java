...
/**
 * Block entity for special lanterns from Chipped mod, tracking their burn time.
 * Implements Burnable for standardized burn time management.
 */
public class SpecialLanternBlockEntity extends BlockEntity implements Burnable {
    private static final String REMAINING_KEY = "remaining_burn";
    private long remainingBurnTime;

    public SpecialLanternBlockEntity(BlockPos pos, BlockState state) {
        super(ChippedModBlockEntities.SPECIAL_LANTERN_BLOCK_ENTITY, pos, state);
